...
import com.weiyi.wx.order.request.QueryPeriodSalesRequest;
import com.weiyi.wx.order.request.QueryUserAllSalesRequest;
import com.weiyi.wx.order.request.QueryUserInfoRequest;
import com.weiyi.wx.order.request.UpdateUserInfoRequest;
import com.weiyi.wx.order.response.QueryPeriodSalesResponse;
import com.weiyi.wx.order.response.QueryUserAllSalesResponse;
import com.weiyi.wx.order.response.QueryUserInfoResponse;
import com.weiyi.wx.order.response.UpdateUserInfoResponse;
